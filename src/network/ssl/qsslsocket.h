...
public:
    ...
    void connectToHostEncrypted(const QString &hostName, const QString &hostFqdn, quint16 port, const QString &sslPeerName, OpenMode mode = ReadWrite, NetworkLayerProtocol protocol = AnyIPProtocol);
